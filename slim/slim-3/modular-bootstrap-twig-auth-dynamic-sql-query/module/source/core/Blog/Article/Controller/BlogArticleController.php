...
class BlogArticleController extends AbstractController
{
    ...
    public function __invoke(Request $request, Response $response, array $args)
    {
        ...
        // Gateway & Mapper.
        $BlogArticleGateway = new BlogArticleGateway($Database);
        ...
        // Visitors.
        $BlogArticleTemplateMapper = new BlogArticleTemplateMapper(new BlogArticleTemplateGateway($Database));
        $BlogArticleContentMapper = new BlogArticleContentMapper(new BlogArticleContentGateway($Database));
